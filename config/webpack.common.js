  ...
  return {
      ...
      rules: [
        ...
        },
        {
          ...
          use: [
            ...
            /**
             * webpack 3.x awesome-typescript-loader
             * */
            // {
    ...
    plugins: [
      ...
      */
      ...
      /**
       * Because TS will generate .js and .d.ts files, you should ignore these files,
       *  otherwise watchers may go into an infinite watch loop. 
       * For example, when using Webpack, you may wish to add this to your webpack.conf.js file:
       */
